...
__weak void USBD_CDC_TxCpltcallback(uint8_t* Buf, uint32_t* Len) {}
__weak void USBD_CDC_RxCpltcallback(uint8_t* Buf, const uint32_t* Len) {}
...
static int8_t CDC_TransmitCplt_HS(uint8_t *Buf, uint32_t *Len, uint8_t epnum)
{
  ...
  /* USER CODE BEGIN 14 */
    ...
    UNUSED(Len);
    UNUSED(epnum);
    USBD_CDC_TxCpltcallback(Buf, Len);
  /* USER CODE END 14 */
  return result;
}
